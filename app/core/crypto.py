"""Шифрование учётных данных пользователей и выдача секретов для ICS-ссылок.

Честно о границах защиты. Пароли шифруются симметрично, ключ лежит в окружении
...
class CredentialsCipher:
    """Обёртка над Fernet для паролей от личного кабинета."""
